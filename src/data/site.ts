...
export const markets: readonly Market[] = [
  {
    ...
    image: {
      ...
      alt: 'The downtown San Diego skyline across the bay at sunset, its towers lit under a pink sky',
      width: 2400,
      height: 1330,
      hasSmall: true,
    },
  ...
  },
  {
    ...
    image: {
      ...
      alt: 'Wind turbines in the desert outside Palm Springs with the snow-capped San Jacinto Mountains behind them',
      width: 2400,
      height: 1666,
      hasSmall: true,
      position: 'center 68%',
  ...
  },
  {
    ...
    image: {
      ...
      alt: 'Big Bear Lake from above in winter, snow-covered mountains and a cabin-lined shore under a cloudy sky',
      width: 2400,
      height: 1800,
      hasSmall: true,
    },
