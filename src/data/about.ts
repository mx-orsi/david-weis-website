...
export const aboutChapterB: ProjectChapter = {
  ...
  blocks: [
    ...
    },
    {
      ...
      label: 'The Cole',
      photos: [
        { suggestion: 'The Cole Hotel - Mark and I before', src: '/images/about/david-weis-mark-the-cole-before.jpg', alt: 'David and Mark Weis at The Cole Hotel property before its renovation' },
        {
        ...
        { suggestion: 'The Cole Hotel - Mark and I when sold', src: '/images/about/david-weis-mark-the-cole-when-sold.jpg', alt: 'David and Mark Weis at The Cole Hotel on the day it sold' },
        { suggestion: 'Our wedding at The Cole', src: '/images/about/david-weis-mark-wedding-the-cole.jpg', alt: 'David and Mark Weis at their wedding, held at The Cole Hotel in Palm Springs' },
      ],
    ...
    },
    {
      ...
      photos: [
        { suggestion: 'First Listing', src: '/images/about/david-weis-first-listing.jpg', alt: 'David Weis at the sign for his first real estate listing' },
        { suggestion: 'Legislative Day 2023', src: '/images/about/david-weis-legislative-day-sacramento-2023.jpg', alt: 'David Weis at REALTOR® Legislative Day in Sacramento, 2023' },
        { suggestion: 'Broker caravan', src: '/images/about/david-weis-broker-caravan.jpg', alt: 'David Weis presenting a listing at a broker caravan' },
        { suggestion: 'A sold property', src: '/images/about/david-weis-sold-property.jpg', alt: 'A "Sold" sign at one of David Weis’s listings' },
      ],
      captions: [{ title: 'First listing' }, { title: 'Legislative Day, Sacramento' }, { title: 'Broker caravan' }, { title: 'Sold' }],
    },
    {
      type: 'story',
    ...
    },
    {
      ...
      photos: [
        ...
        { suggestion: 'Boating in San Diego', src: '/images/about/david-weis-boating-san-diego.jpg', alt: 'David Weis boating on the water in San Diego' },
        { suggestion: 'Beach sunset with the dog', src: '/images/about/david-weis-beach-sunset-dog.jpg', alt: 'David Weis with his dog on the beach at sunset' },
      ],
    },
    {
      type: 'story',
    ...
    },
    {
      ...
      photos: [
        ...
        { suggestion: 'A Palm Springs bike ride', src: '/images/about/david-weis-palm-springs-bike-ride.jpg', alt: 'David Weis on a bike ride in Palm Springs' },
    ...
    },
    {
      ...
      label: 'Big Bear',
      photos: [
        { suggestion: 'Hiking at an overlook, Big Bear', src: '/images/about/david-weis-big-bear-hiking-overlook.jpg', alt: 'David Weis hiking at an overlook in Big Bear' },
        { suggestion: 'The Big Bear Turkey Trot', src: '/images/about/david-weis-big-bear-turkey-trot.jpg', alt: 'David Weis running in a Big Bear Turkey Trot race' },
        { suggestion: 'Fourth of July with friends, Big Bear', src: '/images/about/david-weis-big-bear-fourth-of-july-friends.jpg', alt: 'David Weis and friends celebrating the Fourth of July in Big Bear' },
      ],
      captions: [undefined, { title: 'Turkey Trot', note: 'The coldest, windiest Turkey Trot I have ever agreed to.' }, undefined],
    },
    {
      type: 'story',
      eyebrow: 'Community',
    ...
    },
    {
      ...
      label: 'Gay For Good',
      photos: [
        { suggestion: 'Gay For Good habitat service day', src: '/images/about/david-weis-gay-for-good-habitat-service.jpg', alt: 'David Weis volunteering with Gay For Good at a Habitat for Humanity service day' },
        { suggestion: 'Gay For Good Hillcrest Honors', src: '/images/about/david-weis-gay-for-good-hillcrest-honors.jpg', alt: 'David Weis at the Hillcrest Honors event representing Gay For Good' },
        { suggestion: 'Gay For Good fundraiser at Querencia Palms', src: '/images/about/david-weis-gay-for-good-fundraiser-querencia-palms.jpg', alt: 'Guests at the Gay For Good national fundraiser hosted at Querencia Palms' },
      ],
      captions: [{ title: 'Service day' }, { title: 'Hillcrest Honors' }, { title: 'The fundraiser at Querencia Palms' }],
    },
    {
      type: 'story',
    ...
    },
    {
      ...
      label: 'Garden Club',
      photos: [
        { suggestion: 'Garden Club May Luncheon Hat Competition', src: '/images/about/david-weis-garden-club-hat-competition.jpg', alt: 'David Weis wearing an elaborate pollinator-themed hat at the Village Garden Club of La Jolla’s hat competition' },
        { suggestion: 'Rosemary simple syrup', src: '/images/about/david-weis-garden-club-rosemary-syrup.jpg', alt: 'Jars of rosemary simple syrup made for the Village Garden Club of La Jolla holiday pantry' },
        { suggestion: 'La Jolla Light coverage', src: '/images/about/david-weis-garden-club-la-jolla-light.jpg', alt: 'A La Jolla Light newspaper clipping featuring the Village Garden Club hat competition' },
        { suggestion: 'Refreshment table', src: '/images/about/david-weis-garden-club-refreshment-table.jpg', alt: 'A refreshment table set up for a Village Garden Club of La Jolla event' },
      ],
      captions: [{ title: 'The hat' }, { title: 'Rosemary simple syrup' }, { title: 'La Jolla Light' }, { title: 'Refreshment table' }],
    },
    {
      type: 'story',
    ...
    },
    {
      ...
      photos: [
        ...
        { suggestion: 'Vista Las Palmas neighborhood event', src: '/images/about/david-weis-vista-las-palmas-neighborhood-event.jpg', alt: 'Neighbors gathered at a Vista Las Palmas neighborhood event' },
      ],
    ...
    },
    {
      ...
      photos: [
        { suggestion: 'Front Runners, San Diego', src: '/images/community/david-weis-front-runners-san-diego-02.jpg', alt: 'The Front Runners running group gathered on the grass in San Diego', width: 1170, height: 1147, hasSmall: true },
        { suggestion: 'Front Runners, Palm Springs', src: '/images/community/david-weis-front-runners-palm-springs.jpg', alt: 'The Front Runners running group posing together outdoors in Palm Springs, mountains and palm trees behind them', width: 1206, height: 825, hasSmall: true },
        { suggestion: 'Pride Sports kickball', src: '/images/about/david-weis-pride-sports-kickball.jpg', alt: 'David Weis playing kickball with a Pride Sports league team' },
        { suggestion: 'Red Dress Party volunteer', src: '/images/about/david-weis-red-dress-party-volunteer.jpg', alt: 'David Weis volunteering behind the scenes for the Red Dress Party promotional video' },
        { suggestion: 'OUT Professionals', src: '/images/about/david-weis-out-professionals.jpg', alt: 'David Weis at an OUT Professionals networking event' },
      ],
    ...
    },
    {
      ...
      photos: [
        { suggestion: 'With Mark, at an H3K project', src: '/images/about/david-weis-mark-h3k-property.jpg', alt: 'David and Mark Weis at an H3K design project in Palm Springs' },
        { suggestion: 'H3K design detail', src: '/images/about/h3k-design-detail-palm-springs.jpg', alt: 'A design detail from an H3K project in Palm Springs' },
        { suggestion: 'H3K pool and courtyard', src: '/images/about/h3k-pool-courtyard-palm-springs.jpg', alt: 'A pool and courtyard at an H3K-designed property in Palm Springs' },
        { suggestion: 'Modernism Week with Kathy', src: '/images/about/david-weis-modernism-week-kathy.jpg', alt: 'David Weis with Kathy at a Modernism Week event in Palm Springs' },
      ],
    ...
    },
    {
      ...
      photos: [
        { suggestion: 'Holiday gift bag production', src: '/images/about/holiday-gift-bag-production.jpg', alt: 'Holiday gift bags being assembled for David and Mark’s annual fundraiser' },
        { suggestion: 'Toy collection for the Marines', src: '/images/about/holiday-toy-collection-marines.jpg', alt: 'Donated toys collected for the Marines’ Toys for Tots program at the holiday fundraiser' },
        { suggestion: 'Toys loaded into the Range Rover', src: '/images/about/holiday-toys-range-rover.jpg', alt: 'Donated toys loaded into a Range Rover after the holiday fundraiser' },
        { suggestion: 'Illustrated holiday card', src: '/images/about/holiday-illustrated-card.jpg', alt: 'An illustrated holiday card designed for David and Mark’s annual fundraiser' },
        { suggestion: 'Querencia Palms s’mores kit', src: '/images/about/holiday-smores-kit-querencia-palms.jpg', alt: 'A custom s’mores kit with Querencia Palms branding made for the holiday fundraiser' },
        { suggestion: 'Holiday party portrait', src: '/images/about/holiday-party-portrait.jpg', alt: 'David and Mark Weis at their annual holiday fundraiser party' },
      ],
    },
    {
      type: 'gallery',
      ...
      photos: [
        { suggestion: 'Holiday cookie decorating competition entry', src: '/images/about/holiday-cookie-competition.jpg', alt: 'David Weis’s decorated entry in a holiday cookie decorating competition' },
      ],
    ...
    },
    {
      ...
      photos: [
        { suggestion: 'Horseback riding', src: '/images/about/david-weis-horseback-riding.jpg', alt: 'David Weis horseback riding' },
        {
        ...
        { suggestion: 'Coachella', src: '/images/about/david-weis-coachella.jpg', alt: 'David Weis at the Coachella music festival' },
        { suggestion: 'Snowboarding in Big Bear', src: '/images/about/david-weis-big-bear-snowboarding.jpg', alt: 'David Weis snowboarding in Big Bear' },
        { suggestion: 'Friends at Big Bear Lake', src: '/images/about/david-weis-big-bear-lake-friends.jpg', alt: 'David Weis and friends at Big Bear Lake' },
        {
        ...
        { suggestion: 'Village Garden Club of La Jolla', src: '/images/about/david-weis-garden-club-la-jolla.jpg', alt: 'David Weis at a Village Garden Club of La Jolla event' },
      ],
    },
    {
      type: 'story',
    ...
    },
    {
      ...
      photos: [
        { suggestion: 'The Chevy Colorado', src: '/images/about/david-weis-chevy-colorado.jpg', alt: 'David Weis’s Chevy Colorado truck' },
        { suggestion: 'The Range Rover work truck', src: '/images/about/david-weis-range-rover-work-truck.jpg', alt: 'A Range Rover loaded with plants and supplies, used as a work truck' },
